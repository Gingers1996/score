...
def main():
    ...
    with st.sidebar.form("cutoff_form", clear_on_submit=False):
        ...
        level2 = st.text_input("Level2 ≥", str(int(st.session_state['cutoffs']['Level2'])), help="请输入0-100的整数")
        level3 = st.text_input("Level3 ≥", str(int(st.session_state['cutoffs']['Level3'])), help="请输入0-100的整数")
        level4 = st.text_input("Level4 ≥", str(int(st.session_state['cutoffs']['Level4'])), help="请输入0-100的整数")
        level5 = st.text_input("Level5 ≥", str(int(st.session_state['cutoffs']['Level5'])), help="请输入0-100的整数")
        level6 = st.text_input("Level6 ≥", str(int(st.session_state['cutoffs']['Level6'])), help="请输入0-100的整数")
        level7 = st.text_input("Level7 ≥", str(int(st.session_state['cutoffs']['Level7'])), help="请输入0-100的整数")
